      ...
      input_schema: {
        ...
        properties: {
          ...
          startDatetime: {
            type: 'string',
            description:
              '수정할 시작 일시 (ISO 8601, 반드시 15분 단위 & +09:00 오프셋 포함, 예: 2025-05-10T14:00:00+09:00, 2025-05-10T14:15:00+09:00)',
          },
          endDatetime: {
            type: 'string',
            description:
              '수정할 종료 일시 (ISO 8601, 반드시 15분 단위 & +09:00 오프셋 포함, 예: 2025-05-10T16:00:00+09:00, 2025-05-10T15:45:00+09:00)',
          },
          attendeeSlackIds: {
            type: 'array',
            items: { type: 'string' },
