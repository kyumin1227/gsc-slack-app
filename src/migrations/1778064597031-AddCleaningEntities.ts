...
export class AddCleaningEntities1778064597031 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "cleaning_assignments" ADD CONSTRAINT "FK_42ea819fed40960a6aa464b1799" FOREIGN KEY ("studentId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
